...
public class TimeEntryService {
    ...
    public List<TimeEntry> getEntriesByWeek(LocalDate weekStart, Long userId) {
    ...
    public TimeEntry saveTimeEntry(TimeEntry entry) {
        if (entry.getId() == null) {
    ...
    public List<TimeEntry> getEntriesByProject(String project, Long userId) {
        return entityManager.createQuery(
            "SELECT t FROM TimeEntry t WHERE t.user.id = :userId " +
    ...
    public boolean validateTimeEntry(TimeEntry entry) {
