<%-- 
    Document   : detailsRessource
    Created on : 14 avr. 2025, 20:16:24
    Author     : L13
--%>
            ...
            <div class="container">
                <div class="app-header">
                    ...
                    <div class="header-top">
                        ...
                        <div class="header-actions">
                            <button class="btn-action" onclick="window.location.href='${pageContext.request.contextPath}/views/editRessource.jsp?id=${ressource.id}'">
                                <i class="fas fa-edit"></i> Modifier
                            </button>
                            <button class="btn-action btn-danger" onclick="confirmerSuppression(${ressource.id})">
                ...
                <div class="form-container">
                    <div class="form-section">
                        ...
                        <p><strong>Code de l'employé :</strong> ${ressource.code}</p>
                        <p><strong>Nom :</strong> ${ressource.nom}</p>
                        <p><strong>Numéro d'identité :</strong> ${ressource.identite}</p>
                        <p><strong>Nationalité :</strong> ${ressource.nationalite}</p>
                        <p><strong>Genre :</strong> ${ressource.genre}</p>
                        <p><strong>Date de naissance :</strong> <fmt:formatDate value="${ressource.dateNaissance}" pattern="dd/MM/yyyy" /></p>
                    </div>

                    <div class="form-section">
                        <h4 class="section-title">Informations Professionnelles</h4>
                        <p><strong>Qualification éducative :</strong> ${ressource.qualification}</p>
                        <p><strong>Titre du poste :</strong> ${ressource.poste}</p>
                        <p><strong>Téléphone :</strong> ${ressource.telephone}</p>
                        <p><strong>Email :</strong> ${ressource.email}</p>
                ...
                <div class="form-container">
                    <div class="form-section">
                        ...
                        <p><strong>Type de contrat :</strong> ${ressource.contrat}</p>
                        <p><strong>Date de début :</strong> <fmt:formatDate value="${ressource.dateDebut}" pattern="dd/MM/yyyy" /></p>
                        <p><strong>Date de fin :</strong> <fmt:formatDate value="${ressource.dateFin}" pattern="dd/MM/yyyy" /></p>
                        <p><strong>Durée du contrat :</strong> 
                            <c:set var="diffMillis" value="${ressource.dateFin.time - ressource.dateDebut.time}" />
                            <c:set var="diffDays" value="${diffMillis / (24 * 60 * 60 * 1000)}" />
                            <fmt:formatNumber value="${diffDays}" pattern="#" /> jours
                        </p>
                    </div>

                    <div class="form-section">
                        <h4 class="section-title">Rémunération et Affectation</h4>
                        <p><strong>Salaire :</strong> <fmt:formatNumber value="${ressource.salaire}" type="currency" currencySymbol="DA" /></p>
                        <p><strong>Branche :</strong> ${ressource.branche}</p>
                    </div>
                </div>
    ...
    <div class="modal" id="deleteModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Confirmez-vous la suppression de cette ressource ?</p>
            </div>
            <div class="modal-footer">
                <form method="post" action="${pageContext.request.contextPath}/ressource/delete">
